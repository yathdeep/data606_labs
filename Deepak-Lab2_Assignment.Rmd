---
title: "Chapter 2 Lab - Summarizing Data"
...
***********************************************************************
***Answer
data looks like right skewed and so we can get somewhat more predictable results based on IQR which describes more distribution near median.
***********************************************************************
...
sfo_feb_flights %>%
  summarise(mean_ad = mean(arr_delay),median_ad= median(arr_delay), iqr_dd = IQR(arr_delay), n_flights = n())
```
...
Based on results we can say that DL and UA have more delays because their IQR is highest(22).
...
###Most people travel during holiday season to meet their near and dear ones but from the data presented it appears July has the highest average delay.###
***********************************************************************
...
***********************************************************************
***Answer 
#Mean pro- most commonly way to get the average and no particular order is required to be setup to calculate this.
      con- if one value is too far from the other then it can give the wrong interpretation of value.

#Median pro- the con of mean is not a possibility here.One too far value does not change the result easily.Median value is better to know that mean although this takes more work.
        con- to do this the numbers must be put in order first from least to highest.This is tricky to calculate depending on the set of numbers provided.
***********************************************************************
...
***********************************************************************
***Answer
As the distance increases the average speed looks increased
***********************************************************************
...
***********************************************************************
***Answer    
##from the scatter plot we can see that departure delay of anywhere between 0-60 mins also lands us probably on time. Also noticed that even if there is no departure delay still there is arrival delay in some cases for these selected carriers. So the best chance to arrive on time without any delays would be somewhere around 5-8 mins before actual departure time.
***********************************************************************
