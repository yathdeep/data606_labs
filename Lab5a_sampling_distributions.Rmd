...
#Answer : Since  sample proportions are approximately normal  hence the proportions will be somewhat similar.
...
#Answer : samp2 proportion is different than samp1 but pretty close. Bigger sample size provides better estimates so size 1000.
```{r}
...
#Answer: 15000 elements . This plot looks mostly normally distributed, with a slight skew to the right.The center seems to peak around .2 what looks consistent with the population distribution as we can see from below calculations.
```{r}
...
global_monitor %>%
  summarise(mu = mean(scientist_work == "Doesn't benefit"), pop_med = median(scientist_work == "Doesn't benefit")) 
...
#Answer: There are 22 observations.Each observation represents a sample proportion 
#which makes the sampling distribution and as the sample size gets smalled , the spread get wider and we are not likely to be get the true estimate of the population
...
#Answer: the best point estimate of the population proportion of people who think the work 
#scientists do enchances their lives is about 80%
...
#Answer :repeating the sample 2000 times or more  gets the result closer to the true estimate
#of the population proportion of people who think the work scientist do enhances their lives .
#mean is approx 79%
...
#Answer:would prefer a sampling distribution with a small spread predict because there is much
#less variability in it. That could mean that the sample could be closer to the true proportion.
* * *
