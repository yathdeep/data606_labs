...
********************************************************************************
*Answer
Streak length of 1 means - 1 hit followed by 1 miss

Streak length of 0 means - 0 hit and 1 miss
...
```{r set-seed}
set.seed((9112915))                 # make sure to change the seed
sim_unfair_coin <- sample(coin_outcomes, size = 100, replace = TRUE, 
                          prob = c(0.2, 0.8))

sprintf("number of heads in 100 flips came as 21 heads")
...
********************************************************************************
***ANSWER**
Probability of hits needs to change to 45% and misses to 55%
...
***************************************************************************
***Answer: This is right skewed. Typical streak length is  0.Longest 
streak is 6.Range is from 0-6.
*****************************************************************
```{r}
...
********************************************************************************
*Answer 
The distribution should be similar to the first run since the shots are 
...
********************************************************************************
*Answer 
Mostly similar pattern with kobe's and info points that there are   
more streaks pointing to mode 0.Kobe's data does not fit hot hand model because
we see more data in 0 streak range there also.
********************************************************************************
* * *
